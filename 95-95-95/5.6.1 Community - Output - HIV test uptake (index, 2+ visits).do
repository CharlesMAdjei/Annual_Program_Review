...
*** Test uptake amongst negative and unknown index with 2+ visits
* 26 May 2021
...
putexcel set ///
	"$output/HIV testing/caregiver/Test uptake incl 0 - index unknown - 1yr sample (2+ visits) ($S_DATE).xlsx", ///
	replace
...
putexcel set ///
	"$output/HIV testing/caregiver/Test uptake excl 0 - index unknown - 1yr sample (2+ visits) ($S_DATE).xlsx", ///
	replace
...
* --> Number of tests including 0
putexcel set ///
	"$output/HIV testing/caregiver/Test uptake incl 0 - index neg - 1yr sample (2+ visits) ($S_DATE).xlsx", ///
	replace
...
* --> Number of tests excl 0
putexcel set ///
	"$output/HIV testing/caregiver/Test uptake excl 0 - index neg - 1yr sample (2+ visits) ($S_DATE).xlsx", ///
	replace
...
putexcel set ///
	"$output/HIV testing/caregiver/Test uptake incl 0 - index unknown - 2yr sample (2+ visits) ($S_DATE).xlsx", ///
	replace
...
forvalues i=1/3 {
	putexcel set ///
		"$output/HIV testing/caregiver/Test uptake incl 0 - index unknown - 2yr sample (2+ visits) country `i' ($S_DATE).xlsx", ///
		replace
...
putexcel set ///
	"$output/HIV testing/caregiver/Test uptake excl 0 - index unknown - 2yr sample (2+ visits) ($S_DATE).xlsx", ///
	replace
...
* --> Since enrolment, in 1st year and in 2021, excl 0 tests, for each country
	forvalues i=1/3 {
		putexcel set ///
			"$output/HIV testing/caregiver/Test uptake excl 0 - index unknown - 2yr sample (2+ visits) country `i' ($S_DATE).xlsx", ///
			replace
...
putexcel set ///
	"$output/HIV testing/caregiver/Test uptake incl 0 - index neg - 2yr sample (2+ visits) ($S_DATE).xlsx", ///
	replace
...
forvalues i=1/3 {
	putexcel set ///
		"$output/HIV testing/caregiver/Test uptake incl 0 - index neg - 2yr sample (2+ visits) country `i' ($S_DATE).xlsx", ///
		replace
...
* --> Since enrolment, in 1st year and in 2021, excl 0 tests
putexcel set ///
	"$output/HIV testing/caregiver/Test uptake excl 0 - index neg - 2yr sample (2+ visits) ($S_DATE).xlsx", ///
	replace
...
forvalues i=1/3 {
	putexcel set ///
		"$output/HIV testing/caregiver/Test uptake excl 0 - index neg - 2yr sample (2+ visits) country `i' ($S_DATE).xlsx", ///
		replace
