...
*** Community analysis - Test uptake among partners with 2+ visits
* 26 May 2021
...
putexcel set ///
	"$output/HIV testing/partner/Test uptake incl 0 - partner with non-pos index - 1yr sample (2+ visits) ($S_DATE).xlsx", ///
	replace
...
putexcel set ///
	"$output/HIV testing/partner/Test uptake incl 0 - partner with pos index - 1yr sample (2+ visits) ($S_DATE).xlsx", ///
	replace
...
* --> Number of tests for partners of non-pos index (including 0)
putexcel set ///
	"$output/HIV testing/partner/Test uptake incl 0 - partner with non-pos index - 2yr sample (2+ visits) ($S_DATE).xlsx", ///
	replace
...
putexcel set ///
	"$output/HIV testing/partner/Test uptake incl 0 - partner with pos index - 2yr sample (2+ visits) ($S_DATE).xlsx", ///
	replace
