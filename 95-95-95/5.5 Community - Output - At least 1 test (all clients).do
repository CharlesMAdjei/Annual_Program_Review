...
*** Community analysis - At least 1 test amongst all client types
* 26 May 2021
...
putexcel set ///
	"$output/HIV testing/All clients/At least 1 test - all clients - 1yr sample ($S_DATE).xlsx", ///
	replace
...
putexcel set ///
	"$output/HIV testing/All clients/At least 1 test - all clients (sep by status) - 1yr sample ($S_DATE).xlsx", ///
	replace
...
* --> Original version (unknown + neg combined for each)	
putexcel set ///
	"$output/HIV testing/All clients/At least 1 test - all clients - 2yr sample ($S_DATE).xlsx", ///
	replace
...
* --> New version (unknown + neg separated for each)
putexcel set ///
	"$output/HIV testing/All clients/At least 1 test - all clients (sep by status) - 2yr sample ($S_DATE).xlsx", ///
	replace
...
* --> Original version (unknown + neg combined for each)	
putexcel set ///
	"$output/HIV testing/All clients/At least 1 test - all clients - 3yr sample ($S_DATE).xlsx", ///
	replace
...
* --> New version (unknown + neg separated for each)
putexcel set ///
	"$output/HIV testing/All clients/At least 1 test - all clients (sep by status) - 3yr sample ($S_DATE).xlsx", ///
	replace
